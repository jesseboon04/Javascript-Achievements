...
let fotos = ['100good.jpg', 'goodjob.jpg', 'betternext.jpg', 'betternext2.jpg']
...
let foto=fotos[playerData.wrongAnswers]
let afbeeldingen=document.getElementById("afbeeldingen")
...
function finishQuiz() {
  ...
  afbeeldingen.src="100good.jpg";
  if(playerData.wrongAnswers==1){
    afbeeldingen.src="goodjob.jpg";
  }
  if(playerData.wrongAnswers==2){
    afbeeldingen.src="betternext.jpg";
  }
  if (playerData.wrongAnswers==3){
    afbeeldingen.src="betternext2";
  }
